 ...
 * {@link Label} instances are flyweights. That is, the class' design makes it so that (barring multithreading or reflection shenanigans) there can be at most one {@link Label} instance per name. Use {@link #create(String)} and {@link #create()} to generate fresh {@link Label} instances.
 */
