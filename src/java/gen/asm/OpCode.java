...
public abstract class OpCode{
  ...
  public static final List<TernaryArithmetic>ternaryArithmeticOps=List.of(ADD,ADDU,AND,NOR,OR,MUL,MOVN,MOVZ,SLT,SLTU,SLLV,SRLV,SRAV,SUB,SUBU,XOR);
  public static final List<BinaryArithmetic>binaryArithmeticOps=List.of(DIV,DIVU,MADD,MADDU,MSUB,MSUBU,MULT,MULTU);
  public static final List<UnaryArithmetic>unaryArithmeticOps=List.of(MFHI,MFLO);
  public static final List<ArithmeticWithImmediate> arithmeticWithImmediateOps=List.of(ADDI,ADDIU,ANDI,ORI,SLL,SRA,SRL,SLTI,SLTIU,XORI);
  public static final List<BinaryBranch>binaryBranchOps=List.of(BEQ,BNE);
  public static final List<UnaryBranch>unaryBranchOps=List.of(BEQZ,BGEZ,BGEZAL,BGTZ,BLEZ,BLTZ,BLTZAL,BNEZ);
